...
import MakeMasterForm from './MakeMasterForm';

const MakeMaster = (props: any) => {
    ...
    return (
        !props?.search ?
            <Table
                ...
                columnTitle={["MAKE_NAME", "ACTIVE", "ACTION"]}
                customHeader={["Make Name", "Active", "Action"]}
                columnData={props?.data}
                clickableColumnHeader={["MAKE_NAME"]}
                filterFields={['MAKE_NAME']}
                setSelectedData
